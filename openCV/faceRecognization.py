# Recognise Faces using some classification algorithim -like Logistic,KNN,SVM
# 1.Read a video stream using opencv
# 2.extract faces out of it
# 3.load the training data (numpy arrays of all persons)
        # x -values are sorted in the numpy arrays
        # y-values we need to assigng for each person
...
#     # Fing max frequency and corresponding label
...
while True:
    ...
    for face in faces:
        ...
        # Get the face Region of Intrest
        offset = 10
